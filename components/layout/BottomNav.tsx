...
import { Home, LayoutGrid, ScanLine, ClipboardList, User } from 'lucide-react';
...
export const BottomNav: React.FC = () => {
  ...
  const tabs = [
    ...
    { id: 'scan', isScanner: true, label: 'فحص', icon: <ScanLine className="w-7 h-7 text-white" /> },
                ...
                <div key={tab.id} className="relative flex flex-col items-center justify-center -translate-y-4 z-50">
                  <button
                    onClick={() => {
                      ...
                      setTimeout(() => window.dispatchEvent(new CustomEvent('open-scanner')), 50);
                    }}
