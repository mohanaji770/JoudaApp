...
const MiniBadges: React.FC<{ tags: string[] }> = ({ tags }) => {
  if (!tags || tags.length === 0) {
    return <span className="text-[10px] text-gray-400">لا توجد شارات</span>;
  }
  return (
      ...
      <div className="flex items-center gap-3 overflow-hidden">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2 mt-1">
            <span className="text-[10px] text-gray-400 font-mono bg-gray-50 dark:bg-gray-800 px-1.5 rounded">{product.barcode}</span>
          </div>
        </div>
      </div>
      
      <div className="flex flex-col items-end gap-2 shrink-0 pl-1">
        <MiniBadges tags={product.tags || []} />
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-0 md:p-4 animate-fade-in">
      ...
      <div className="relative w-full md:max-w-md bg-white dark:bg-gray-900 rounded-t-3xl md:rounded-3xl shadow-2xl flex flex-col max-h-[90vh] translate-y-0 animate-slide-up md:animate-scale-in">
            ...
            return (
              ...
              >
                ...
                <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors ${
                  isActive ? 'bg-brand-500 border-brand-500 text-white' : 'border-gray-300 dark:border-gray-600 text-transparent'
                }`}>
        ...
        {/* Footer */}
        <div className="p-5 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 md:rounded-b-3xl">
          <button
            onClick={handleSave}
            disabled={isSaving}
