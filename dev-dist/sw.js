...
define(['./workbox-ab24ae20'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/docs\.google\.com\/spreadsheets\/.*/i, new workbox.NetworkFirst({
