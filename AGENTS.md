...
### ملاحظات
- `admin_pin` لا يزال موجوداً في `app_settings.admin_pin` لكنه **غير مقروء** للعامة. قيمته الحالية: `562422`.
...
- [x] تغيير `admin_pin` من القيمة الافتراضية `0000` إلى الرمز الجديد `562422`
...
بعد أي تغيير جوهري في النظام، حدّث هذا الملف. آخر تحديث: 2026-06-04.
